                ...
                while(x< one*divisor):
                    ...
                    if(res4.status_code==200):
                        ...
                        for hit in hits:
                            ...
                            src = hit['_source']
                            print('id = ',hit['_id'])
                            data_string = table_string.safe_substitute(col1=src['docment_type'],col2=src['document_name'],col3=src['date_from']+'-'+src['date_to'],col4=src['authors'],col5=src['document_date_f'],col6=src['archive'],col7=src['fond'],col8=src['opis'],col9=src['delo'],
